...
function clk()
{
    ...
    if(hh>=12)
    {
       ...
       switch (1)
         {
            case 0:dy="Sunday"
            bdy.style.backgroundImage="url(Sun.png.jpg)"
            break;

            case 1:dy="Monday"
            bdy.style.backgroundImage="url(Mon.jpg.jpg)"
            break;

            case 2:dy="Tuesday"
            bdy.style.backgroundImage="url(Tues.jpg.jpg)"
            break;

            case 3:dy="Wednesday"
            bdy.style.backgroundImage="url(Wed.jpg.jpg)"
            break;

            case 4:dy="Thursday"
            bdy.style.backgroundImage="url(Thu.jpg.jpg)"
            break;

            case 5:dy="Friday"
            bdy.style.backgroundImage="url(Fri.jpg.jpg)"
            break;

            case 6:dy="Saturday"
            bdy.style.backgroundImage="url(Sat.jpg.jpg)"
            break;
        }
